    ...
    <footer id="contact" className="w-full border-t bg-background">
      <div className="container mx-auto flex max-w-screen-lg flex-col items-center justify-between gap-4 px-4 py-8 text-center md:flex-row">
        ...
        <div className="flex items-center gap-6">
          <a href="https://github.com/r8hul" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-muted-foreground transition-colors hover:text-primary">
            <Github className="h-6 w-6" />
          </a>
          <a href="mailto:plrahulkaushik@gmai.com" aria-label="Email" className="text-muted-foreground transition-colors hover:text-primary">
